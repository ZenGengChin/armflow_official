...
from models.regennet2.model.mlp import DiffMLP
from models.regennet2.model.rotation2xyz import Rotation2xyz, Rotation2xyz_x
from models.regennet2.model.transformer_utils import Block, trunc_normal_, positional_encoding
...
class OutputProcess(nn.Module):
    ...
    def forward(self, output):
        if self.data_rep == 'xyz':
            output = output.permute(1, 0, 2) # [b, l, d]
        else:
