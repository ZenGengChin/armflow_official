...
def add_model_options(parser):
    ...
    group.add_argument("--cond_mode", default='no_cond', choices=['text', 'action', 'no_cond'], type=str,
                       help="Model is trained with text or action condition.")



def add_data_options(parser):
    group = parser.add_argument_group('dataset')
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', 'ntu', 'chi3d', 'gta', 'sbu', 'interhuman', 'interx'], type=str,
