...
from models.ardiff.ardiff_module import ARDiffModule
...
def main():
    ...
    cfg = OmegaConf.load('cfg/ardiff/ardiff.yaml')
    ...
    model = ARDiffModule(cfg=cfg)
        
    if os.path.exists('ckpt/' + exp_name + '/last.ckpt'):
        model = ARDiffModule.load_from_checkpoint(
