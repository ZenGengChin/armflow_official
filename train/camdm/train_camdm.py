...
from models.camdm.camdm import CAMDM
...
def main():
    ...
    cfg = OmegaConf.load('cfg/camdm/camdm.yaml')
    ...
    trainer = Trainer(
        ...
        check_val_every_n_epoch=10 if not hasattr(cfg.camdm.train, 'check_val_every_n_epoch') else cfg.camdm.train.check_val_every_n_epoch,
        accelerator='cuda',
        devices=1
    )
